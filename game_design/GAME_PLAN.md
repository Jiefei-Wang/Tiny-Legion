...
- `npm --prefix arena run eval:levels -- --minLevel 2 --maxLevel 6 --seeds 16 --threshold 0.6` runs the real `p4-leaderboard` scenario as deterministic, two-game side-swapped series and fails unless every higher adjacent level wins strictly more than 60% of series. The certified results are L2/L1 `10/16` (62.5%), L3/L2 `10/16` (62.5%), L4/L3 `10/16` (62.5%), L5/L4 `11/16` (68.8%), and L6/L5 `11/16` (68.8%).
