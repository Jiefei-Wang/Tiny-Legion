...
const baselineShootingConfig = AI_SHOOTING_CONFIG.baseline;
const LEAD_VELOCITY_FILTER_RATE_PER_S = baselineShootingConfig.velocityFilterRatePerSecond;
const LEAD_GAIN_NEAR = baselineShootingConfig.leadGainNear;
const LEAD_GAIN_FAR = baselineShootingConfig.leadGainFar;
const LEAD_ACCEL_SOFT_CAP = baselineShootingConfig.accelerationSoftCap;
const LEAD_ACCEL_HARD_CAP = baselineShootingConfig.accelerationHardCap;
const LEAD_ACCEL_MIN_GAIN = baselineShootingConfig.accelerationMinGain;
const AIM_SLEW_DEG_PER_S = baselineShootingConfig.aimSlewDegreesPerSecond;
const AIM_DEADBAND_DEG = baselineShootingConfig.aimDeadbandDegrees;
