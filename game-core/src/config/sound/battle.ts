...
import type { FireSoundPool } from "../../types.ts";
...
export const FIRE_SAMPLE_KEYS = config.firePools as Record<FireSoundPool, readonly BattleSampleKey[]>;
export const FIRE_SAMPLE_RATE = config.firePlaybackRates as Record<FireSoundPool, number>;
