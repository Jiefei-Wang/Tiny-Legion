...
export const GAME_CONFIG_DESCRIPTIONS = {
  "balance": {
    ...
    "units": {
      ...
      "components.cannonLoader.loader.supports": "Weapon classes this loader is allowed to service.",
      ...
      "components.missileLoader.loader.supports": "Weapon classes this loader is allowed to service.",
    ...
    "weapons": {
      ...
      "components.rapidGun.weaponClass": "Weapon behavior class used by firing, AI, projectile, and audio systems.",
      ...
      "components.heavyCannon.weaponClass": "Weapon behavior class used by firing, AI, projectile, and audio systems.",
      ...
      "components.explosiveShell.weaponClass": "Weapon behavior class used by firing, AI, projectile, and audio systems.",
      ...
      "components.trackingMissile.weaponClass": "Weapon behavior class used by firing, AI, projectile, and audio systems.",
      ...
      "components.precisionBeam.weaponClass": "Weapon behavior class used by firing, AI, projectile, and audio systems.",
