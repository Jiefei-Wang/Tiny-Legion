...
export const MATERIALS: Record<MaterialId, MaterialStats> = {
  basic: { label: "normal steel", mass: 50, armor: 10, hp: 100, recoverPerSecond: 10, color: "#66788d" },
  reinforced: { label: "Reinforced", mass: 13, armor: 1.3, hp: 150, recoverPerSecond: 1.9, color: "#8ca3bd" },
  ceramic: { label: "heavy steel", mass: 100, armor: 15, hp: 200, recoverPerSecond: 20, color: "#3f4b5a" },
